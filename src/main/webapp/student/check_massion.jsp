        ...
        <form action="/student/Submit_fileServlet" method="post" enctype="multipart/form-data">
            <div style="width: 80%;margin: 0 auto;overflow: hidden;margin-left: 9%;" id="div3" class="main">
                ...
                <div >
                    ...
                    <%--任务附件部分--%>
                    <c:if test="${empty studentTask2.getTask_file()}">
                    ...
                    <div >
                        ...
                        <textarea onclick="show()" rows="" readonly style="border: 1px solid black;height: 120px;"   id="task_content"name="task_content"   cols="70" rows="10"> ${studentTask2.getAnswer()}
                    ...
                    <div b>
                        <div>教师评语：</div>
                        <div>${studentTask2.getRemark()}</div>
                    </div>
                </div>
            </div>
            <script type="text/javascript">
